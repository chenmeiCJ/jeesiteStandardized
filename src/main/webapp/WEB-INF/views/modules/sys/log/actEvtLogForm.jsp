...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/log/actEvtLog/">日志列表</a></li>
		<li class="active"><a href="${ctx}/sys/log/actEvtLog/form?id=${actEvtLog.id}">日志<shiro:hasPermission name="sys:log:actEvtLog:edit">${not empty actEvtLog.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:log:actEvtLog:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="actEvtLog" action="${ctx}/sys/log/actEvtLog/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="sys:log:actEvtLog:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
