...
<head>
	...
	<style type="text/css">
		...
		#header {margin:0 0 8px;position:static;} #header li {font-size:21px;_font-size:19px;}
		.navbar li { line-height: 62px;}
		#header .brand {font-family:Helvetica, Georgia, Arial, sans-serif, 黑体;font-size:34px;padding-left:33px;}
	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				<div class="brand">
			    <img src="${ctxStatic}/images/title.png" height="65" width="65"/>
